          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span className={`rounded px-2 py-1 text-xs font-bold ${slot.status === "AVAILABLE" ? "bg-emerald-100 text-emerald-800" : "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300"}`}>
                  {slot.status}
                </span>
              </div>
